(function(jcf){jcf.addModule(function($,window){'use strict';var module={name:'Select',selector:'select.present',options:{element:null,multipleCompactStyle:!1},plugins:{ListBox:ListBox,ComboBox:ComboBox,SelectList:SelectList},matchElement:function(element){return element.is('select')},init:function(){this.element=$(this.options.element);this.createInstance()},isListBox:function(){return this.element.is('[size]:not([jcf-size]), [multiple]')},createInstance:function(){if(this.instance){this.instance.destroy()}
