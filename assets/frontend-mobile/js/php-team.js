jQuery(document).ready(function($) {
        ...
        $(window).scroll(function() {
            if (bottom && $(window).scrollTop() >= ($('.masonrow').offset().top + $('.masonrow').outerHeight() - window.innerHeight)) {
                ...
                $.ajax({
                    ...
                    /* TYPE OF METHOD TO USE TO PASS THE DATA */
                    dataType: "json",
                    url: "<?php echo base_url('mobilehome/index'); ?>",
                    /* PAGE WHERE WE WILL PASS THE DATA */
                    data: {
                        page: page
                    },
    ...
    $(".parent_cat_").on('change', function(e) {
        ...
        $.ajax({
            ...
            /* TYPE OF METHOD TO USE TO PASS THE DATA */
            dataType: "json",
            url: "<?php echo base_url('child-cats'); ?>",
            /* PAGE WHERE WE WILL PASS THE DATA */
            data: {
    ...
    $('#profile_pic_').on('change', function() {
        ...
        $.ajax({
            /* THEN THE AJAX CALL */
            url: "<?php echo base_url('mobilehome/update_profile_pic'); ?>",
            /* PAGE WHERE WE WILL PASS THE DATA */
            type: "POST",
            /* TYPE OF METHOD TO USE TO PASS THE DATA */
            contentType: false,
    ...
    $('.post_del_submit_btn').on('click', function() {
        ...
        $.ajax({
            /* THEN THE AJAX CALL */
            url: "<?php echo base_url('dashboard/del-my-ads'); ?>",
            /* PAGE WHERE WE WILL PASS THE DATA */
            type: "POST",
            /* TYPE OF METHOD TO USE TO PASS THE DATA */
            data: {
                postIds: myCheckboxes
            },
            /* THE DATA WE WILL BE PASSING */
    ...
    $(".follow_add_listing").click(function(e) {
        ...
        $.ajax({
            ...
            /* TYPE OF METHOD TO USE TO PASS THE DATA */
            dataType: "json",
            url: "<?php echo base_url('dashboard/follow_add'); ?>",
            /* PAGE WHERE WE WILL PASS THE DATA */
            data: {
                listing_id: listing_id,
                userid: userid
    ...
    $(".remove_follow_listing").click(function(e) {
        ...
        $.ajax({
            ...
            /* TYPE OF METHOD TO USE TO PASS THE DATA */
            dataType: "json",
            url: "<?php echo base_url('dashboard/remove_follow'); ?>",
            /* PAGE WHERE WE WILL PASS THE DATA */
            data: {
                listing_id: listing_id,
                userid: userid
