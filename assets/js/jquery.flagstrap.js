    ...
    $.flagStrap = function (element, options, i) {
        ...
        var buildDropDownButtonItemList = function () {
            var items = $('<ul/>')
                ...
                .addClass('dropdown-menu slect_country');
            ...
            //custom code written by husnain 
            var flagInp = $('<input/>')
                .attr('type', 'text')
                .attr('placeholder', 'Select Country')
                .attr('id', 'fddown')
                .addClass('dropdown-input'); 
            var listInp = $('<li/>').prepend(flagInp);
            items.append(listInp);

            $( function() {
                $('#fddown').keyup( function(ev) {
                ...
                function filtro(texto) {
                    var lista = $("ul.dropdown-menu li a").hide().filter(function(){
                        var item = $(this).text();
            ...
            $(document).on("click", function(event){
                ...
                if( $trigger !== event.target && !$trigger.has(event.target).length){
                  ...
                  $(".dropdown-input").val(''); 
                  var texto;
                  var lista = $("ul.dropdown-menu li a").show().filter(function(){
                        var item = $(this).text();
                        var padrao = new RegExp(texto, "i");                
                        return padrao.test(item);
                });
