...
class Listings_Model extends CI_Model
{
    ...
    public function get_latest_listings($limit = 9,$country_id = null)
    {
        ...
        $this->db->from('listings_new as l');
    ...
    public function header_advance_search($state, $city, $parent_cat, $child_cat, $search_query, $metas, $page, $per_page_limit, $country_id = '')
    {
        ...
        if ($this->input->get('sort') !== NULL) {
            ...
            $meta_sorting = " order by l.meta_values->>'$.price' " . $direction;
        ...
        $make_id = $jsonManipulation->get_make_id_from_make_name($make,$child_cat);
        $model_id = $jsonManipulation->get_model_id_from_model_name($model,$child_cat);
        ...
        if (isset($metas['pricefrom'], $metas['priceto']) && !empty($metas['pricefrom']) && !empty($metas['priceto'])) {
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.price' BETWEEN ({$metas['pricefrom']}*1) and ({$metas['priceto']} * 1) )";
            $counter++;
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.price' >= ({$metas['pricefrom']}*1) )";
            $counter++;
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.price' <= ({$metas['priceto']}*1) )";
            $counter++;
        }
        if (isset($metas)) {
        ...
        if (isset($metas['bedroomsmin'], $metas['bedroomsmax']) && !empty($metas['bedroomsmin']) && !empty($metas['bedroomsmax'])) {
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.rooms' BETWEEN ({$metas['bedroomsmin']}*1) and ({$metas['bedroomsmax']} * 1) )";
            $counter++;
            ...
            $where_metas .= "{$operator}  (l.meta_values->>'$.rooms' >= ({$metas['bedroomsmin']}*1) )";
            $counter++;
            ...
            $where_metas .= "{$operator}  (l.meta_values->>'$.rooms' <= ({$metas['bedroomsmax']}*1) )";
            $counter++;
        }
        if (isset($metas)) {
        ...
        if (isset($metas['sellertype']) && !empty($metas['sellertype'])) {
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.listed' like '{$seller_type}' )";
            $counter++;
        ...
        if (isset($metas['listed']) && !empty($metas['listed'])) {
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.listed' like '{$metas['listed']}' )";
            $counter++;
        ...
        if (isset($metas['yearfrom'], $metas['yearto']) && !empty($metas['yearfrom']) && !empty($metas['yearto'])) {
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.year' BETWEEN {$metas['yearfrom']} and {$metas['yearto']}) ";
            $counter++;
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.year' >= {$metas['yearfrom']} ) ";
            $counter++;
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.year' <= {$metas['yearto']} ) ";
            $counter++;
        ...
        if (isset($metas['kilometerfrom'], $metas['kilometerto']) && !empty($metas['kilometerfrom']) && !empty($metas['kilometerto'])) {
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.kilometers' BETWEEN {$metas['kilometerfrom']} and {$metas['kilometerto']}) ";
            $counter++;
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.kilometers' >= {$metas['kilometerfrom']} ) ";
            $counter++;
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.kilometers' <= {$metas['kilometerto']} ) ";
            $counter++;
        }
        if (isset($metas)) {
        ...
        if (isset($metas['condition']) && !empty($metas['condition'])) {
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.condition' = '{$metas['condition']}' ) ";
            $counter++;
        ...
        if (isset($metas['ad_extras']) && !empty($metas['ad_extras']) && is_array($metas['ad_extras'])) {
            foreach ($metas['ad_extras'] as $extra) {
                ...
                $where_metas .= "{$operator} (l.meta_values->>'$.ad_extras' REGEXP '{$extra}' ) ";
                $counter++;
        ...
        if (isset($metas['cv_required']) && (strtolower($metas['cv_required']) === 'yes')) {
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.cv_upload' != '' ) ";
            $counter++;
        ...
        if(isset($metas['color']) && !empty($metas['color'])){
            $metas['color'] = strtolower($metas['color']);
        }
//================================================================================================================================
        // ==================================== Additional Meta =========================================
        ...
        if (isset($metas['price_only'])) {
            ...
            $where_metas .= "{$operator} (l.meta_values->>'$.price' > 0 ) ";
            $counter++;
            unset($metas);

        }
        if (isset($metas['photo_only'])) {
            ...
            $where_metas .= "{$operator} ( l.meta_values->>'$.images_from' != '' AND l.meta_values->>'$.images_from' != 'a:0:{}' ) ";
            $counter++;
            unset($metas);
        }
        if(isset($metas['listing_type'])){
            if ($counter === 0) {
                $operator = ' WHERE ';
            } else {
                $operator = ' AND ';
            ...
            $where_metas .= "{$operator} l.listing_type = '$metas[listing_type]' ";
        }
        if (isset($metas)) {
...
//==========================================ENDS======================================================================================
        ...
        if (isset($metas)) {
            foreach ($metas as $key => $value) {
                ...
                $where_metas .= "{$operator} ( l.meta_values->>'$.{$key}' = '{$value}' )";
                $counter++;
            }
        }
    ...
    private function cast_advance_header_search_result($listings)
    {
        ...
        foreach ($listings['result'] as $listing) {
            $metas = json_decode($listing->meta_values,true);
    ...
    public function get_listing_by_slug($slug)
    {
            ...
            $this->db->select('l.id as listing_id,l.geo_location_lat_lng as lat_lng,l.meta_values, l.uid, l.title, l.slug, l.description, l.country_id, l.sub_category_id, l.status, l.created_at, l.make_id, l.model_id, c.parent_ids as sub_category,
        ...
        if ($listing_info) {
            ...
            $metas = json_decode($listing_info->meta_values,true);
            $obj_metas = array();
            foreach ($metas as $k=>$v){
                if ($k === 'images_from' && (!empty($v))) {
                    if(is_array($v)){
                        $im = $v;
                    }else{
                        $im = unserialize($v);
    ...
    public function get_autos_related_posts($related_post_current_id, $related_post_id)
    {
        ...
        $this->db->select('l.id , l.category_id , l.title, l.slug,l.meta_values');
        $this->db->from('listings_new l');
        ...
        if ($listing_info) {
            ...
            foreach ($listing_info as $single) {
                ...
                $metas = json_decode($single->meta_values,true);
                $obj_metas = array();
                foreach ($metas as $k=>$v){
                    if ($k === 'images_from' && (!empty($v))) {
                        if(is_array($v)){
    ...
    public function get_listings($limit = 9, array $listing_type = ['featured','recommended'],$country_id = null)
    {
        if(empty($country_id)){
            $country_id = intval($this->country_info['country_id']);
        }
        ...
        foreach ($listing_type as $key => $type) {
            ...
            $query = $this->db->query(
                " SELECT l.*, c.id as category_id, c.name as category_name" .
                " From listings_new as l" .
            ...
            $final_listings[$type] = $query->result();
    ...
    public function get_listings_mobile($limit = 10, $page = 1, $country_id = null)
    {
        if(empty($country_id)){
            $country_id = $this->country_info['country_id'];
        }
        ...
        $db_query = "SELECT l.id as listing_id, l.slug,l.meta_values, l.title, c.id as category_id, c.name as category_name" .
            " From listings_new as l" .
            " inner JOIN categories c ON c.id = l.category_id " .
            " WHERE (l.listing_type = 'recommended' OR l.listing_type = 'featured ') " .
            " AND l.status = 'enabled' AND l.country_id = ".$country_id." " .
            " ORDER BY l.id DESC {$limit_offset}";
        ...
        foreach ($listings as $key => $val_arr) {
            ...
            $new_arr['list'][$val_arr->listing_id]['listing_info'] = [
                'listing_id' => $val_arr->listing_id,
                'listing_title' => $val_arr->title,
                'listing_slug' => $val_arr->slug,
            ];
            $new_arr['list'][$val_arr->listing_id]['category_info'] = [
                'category_id' => $val_arr->category_id,
                'category_name' => $val_arr->category_name
            ];

            $listing_meta_info = json_decode($val_arr->meta_values,true);

            foreach ($listing_meta_info as $key=>$listing_meta) {
                $new_arr['list'][$val_arr->listing_id]['metas'][] = [
                    'listing_meta_id' => $val_arr->listing_id,
                    'meta_key' => $key,
                    'meta_value' => $listing_meta,
                ];
            }
        }
    ...
    public function propertysearch($state, $parent_cat, $child_cat, $search_query, $metas, $page, $per_page_limit, $country_id = '')
    {
        ...
        if (isset($metas['sorting']) && !empty($metas['sorting'])) {
            if ($metas['sorting'] == 'asc') {
                ...
                $sorting = "order by l.meta_values->>'$.price' ASC";

                if (isset($metas['price_only']) && isset($metas['photo_only'])) {
                    $where_metas = "AND (l.meta_values->>'$.price' > 0 ) AND (l.meta_values->>'$.images_from' != '' OR l.meta_values->>'$.images_from' != 'a:0:{}' )";
                } elseif (isset($metas['price_only'])) {
                    $where_metas = "AND (l.meta_values->>'$.price' > 0 )";
                } elseif (isset($metas['photo_only'])) {
                    $where_metas = "AND (l.meta_values->>'$.images_from' != '' OR l.meta_values->>'$.images_from' != 'a:0:{}' )";
                }
                $distict = '*';
                $starting_where = ' AND';
                // $counter++;
                ...
                if (isset($metas['price_only']) && isset($metas['photo_only'])) {
                    ...
                    $where_metas = "AND (l.meta_values->>'$.price' = 'price')";
                }
        ...
        if (isset($metas)) {
            ...
            if (isset($metas['pricefrom'], $metas['priceto']) && !empty($metas['pricefrom']) && !empty($metas['priceto'])) {
                $where_metas .= "{$starting_where} (l.meta_values->>'$.price' BETWEEN ({$metas['pricefrom']}*1) and ({$metas['priceto']} * 1) )";
                $counter++;
            } else if (isset($metas['pricefrom']) && !empty($metas['pricefrom'])) {
                $where_metas .= "{$starting_where} (l.meta_values->>'$.price' >= ({$metas['pricefrom']}*1) )";
                $counter++;
            } else if (isset($metas['priceto']) && !empty($metas['priceto'])) {
                $where_metas .= "{$starting_where} (l.meta_values->>'$.price' <= ({$metas['priceto']}*1) )";
                $counter++;
            }
            unset($metas['pricefrom']);
            unset($metas['priceto']);
            ...
            if (isset($metas['buyertype']) && !empty($metas['buyertype'])) {
                ...
                $where_metas .= "{$operator} (l.meta_values->>'$.listed' like '{$metas['buyertype']}' )";
                $counter++;
            ...
            if (isset($metas['furnished']) && !empty($metas['furnished'])) {
                ...
                $where_metas .= "{$operator}  (l.meta_values->>'$.furnished' = '{$metas['furnished']}' )";
                $counter++;
            }
            ...
            if (isset($metas['rooms']) && !empty($metas['rooms']) && $metas['rooms'] != 0) {
                ...
                $where_metas .= "{$operator}  (l.meta_values->>'$.rooms' <= ({$metas['rooms']}*1) )";
                $counter++;
            }
            unset($metas['rooms']);
            ...
            if (isset($metas['bathrooms']) && !empty($metas['bathrooms']) && $metas['bathrooms'] != 0) {
                ...
                $where_metas .= "{$operator}  (l.meta_values->>'$.bathrooms' <= ({$metas['bathrooms']}*1) )";
                $counter++;
            }
            ...
            if (isset($min_area, $max_area) && !empty($min_area) && !empty($max_area)) {
                $where_metas .= "{$operator} (l.meta_values->>'$.size' BETWEEN '{$min_area}' and '{$max_area}' )";
                $counter++;
            } else if (isset($min_area) && !empty($min_area)) {
                $where_metas .= "{$operator} (l.meta_values->>'$.size' >= '{$min_area}' )";
                $counter++;
            } else if (isset($max_area) && !empty($max_area)) {
                $where_metas .= "{$operator} (l.meta_values->>'$.size' <= {$max_area} )";
                $counter++;
            }
            ...
            if (isset($metas['amenities']) && !empty($metas['amenities'])) {
                foreach ($metas['amenities'] as $item) {
                    ...
                    $where_metas .= "{$operator}  (l.meta_values->>'$.amenities' = '{$item}' )";
                    $counter++;
                }
...
// get selected city name
    ...
    public function nearby($country_id = 0, $cat_id = 0)
    {
        if ($country_id > 0 && $cat_id > 0) {
            $parent_cat_id = $this->parent_cat_id($cat_id);
            $query = "SELECT title,slug FROM `listings_new` where country_id = {$country_id} and category_id = {$parent_cat_id} order by id desc limit 5";
            $result = $this->db->query($query);
            // var_dump($result->result());
            return $result->result();
        }
    ...
    (
       SELECT COUNT(lf.id)
       FROM listings_new lf
       WHERE lf.listing_type = 'featured'
     ...
     (
       SELECT COUNT(lr.id)
       FROM listings_new lr
       WHERE lr.listing_type = 'recommended'
