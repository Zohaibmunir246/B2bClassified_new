                                            ...
                                            <a href="<?php echo base_url('category/') . strtolower(volgo_make_slug($recommended_listing['category_info']['category_name']));?>">
                                                ...
                                                <span class="detail-thumb-price">
                                                    ...
                                                    <span class="currency-code">
                                                        <?php echo (!empty($currency_code)) ? strtoupper($currency_code) : volgo_get_currency_unit_by_country_id(); ?>
                                                    </span>
...
<!--                                        <span class="detail-thumb-price">--><?php //echo (!empty($listing_price)) ? volgo_get_currency_unit_by_country_id() . ' ' . number_format($listing_price) : 'N/A'; ?><!--</span>-->
                                    </div>
                                </div>
...
<div class="container-fluid mainWrapper mb-3 desktopHideOnMobile">
    ...
    <div class="row mb-3 flex_container">
