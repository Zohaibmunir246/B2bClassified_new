                        ...
                        <div class="masonry">
                            <?php if (!empty($listings) && isset($listings['recommended'])): ?>
                                <?php foreach ($listings['recommended'] as $recommended_listing) : ?>
                                    ...
                                    $main_category_name = $recommended_listing['category_info']['category_name'];
                                    ...
                                    foreach ($recommended_listing['metas'] as $meta): ?>
                                        ...
                                        <?php if ($meta['meta_key'] === 'images_from' && (!empty($meta['meta_value']))) {
                                            ...
                                            if (!empty($images) && isset($images[0])) {
                                                $listing_image = IMG_BASE_URL . 'listing_images/' . $images[0] . '?x-oss-process=image/auto-orient,1/quality,q_50/watermark,image_d2F0ZXJtYXJrLWxvZ28ucG5nP3gtb3NzLXByb2Nlc3M9aW1hZ2UvcmVzaXplLFBfMzU,g_se,x_0,y_0/format,jpg';
                                    ...
                                    <div
                                        ...
                                        <div class="detail-thumb">
                                            ...
                                            <a href="<?php echo base_url() . strtolower(volgo_make_slug($recommended_listing['category_info']['category_name'])); ?>">
                                                <p class="mas-detail">
                                                    Category: <?php echo $recommended_listing['category_info']['category_name']; ?></p>
                                            </a>
...
//                                    $listing_image = base_url() . 'uploads/general/no-image.jpg';
                                    ...
                                    foreach ($f_listing['metas'] as $meta): ?>
                                        ...
                                        if ($meta['meta_key'] === 'images_from' && (!empty($meta['meta_value']))) {
                                            ...
                                            if (!empty($lm)) {
                                                $listing_image = IMG_BASE_URL . 'listing_images/' . ($lm[0]) . '?x-oss-process=image/auto-orient,1/quality,q_50/watermark,image_d2F0ZXJtYXJrLWxvZ28ucG5nP3gtb3NzLXByb2Nlc3M9aW1hZ2UvcmVzaXplLFBfMzU,g_se,x_0,y_0/format,jpg';
                                            } else {
                                    ...
                                    <div class="item item-<?php echo $f_listing['listing_info']['listing_id']; ?>">
                                        ...
                                        <div class="detail-thumb">
                                            ...
                                            <a href="<?php echo base_url() . strtolower(volgo_make_slug($f_listing['category_info']['category_name'])); ?>">
                                                <p class="mas-detail">
                                                    Category: <?php echo $f_listing['category_info']['category_name']; ?></p>
                                            </a>
                                            <span class="detail-thumb-price">
                                                    <?php
                                                    if(trim($main_category_name) !== "Services" && trim($main_category_name) !== "Jobs" && trim($main_category_name) !== "Jobs Wanted") {
            ...
            <div class="col-md-4 desktopHideOnMobile">
                <div class="sidebarAds">
                    <div class="masonry masonry-sidebar">
                        <?php if (isset($buying_and_seller_leads, $buying_and_seller_leads['buying_lead'])): ?>
                            <?php foreach ($buying_and_seller_leads['buying_lead'] as $lead) :
                                ...
                                <div class="item item-<?php echo $lead['listing_info']['listing_id']; ?> ">
                                    ...
                                    <div class="detail-thumb">
                                        ...
                                        <a href="<?php echo base_url() . strtolower(volgo_make_slug($lead['category_info']['category_name'])); ?>">
                                            <p class="mas-detail">
                                                Category: <?php echo $lead['category_info']['category_name']; ?></p>
                                        </a>
                                        <!--                                        <span class="detail-thumb-price">-->
    ...
    <div class="row mb-3"><!--class="row mb-3 flex_container"-->
        ...
        foreach ($metas_trade_show as $trade_show_single_meta):
            ...
            if(isset($trade_img_height) && !empty($trade_img_height)) {
                $trade_show_image = IMG_BASE_URL . 'tradeshows/' . volgo_maybe_unserialize($trade_show_single_meta['tradeshow_info']['featured_image'])  . '?x-oss-process=image/resize,m_fixed,h_' . $trade_img_height . '/auto-orient,1/quality,q_50/watermark,image_d2F0ZXJtYXJrLWxvZ28ucG5nP3gtb3NzLXByb2Nlc3M9aW1hZ2UvcmVzaXplLFBfMzU,g_se,x_0,y_0/format,jpg';
            }elseif(isset($trade_img_width) && !empty($trade_img_width)){
                $trade_show_image = IMG_BASE_URL . 'tradeshows/' . volgo_maybe_unserialize($trade_show_single_meta['tradeshow_info']['featured_image'])  . '?x-oss-process=image/resize,m_fixed,w_' . $trade_img_width . '/auto-orient,1/quality,q_50/watermark,image_d2F0ZXJtYXJrLWxvZ28ucG5nP3gtb3NzLXByb2Nlc3M9aW1hZ2UvcmVzaXplLFBfMzU,g_se,x_0,y_0/format,jpg';
            }elseif ((isset($trade_img_height) && !empty($trade_img_height)) && (isset($trade_img_width) && !empty($trade_img_width))){
                $trade_show_image = IMG_BASE_URL . 'tradeshows/' . volgo_maybe_unserialize($trade_show_single_meta['tradeshow_info']['featured_image'])  . '?x-oss-process=image/resize,m_fixed,h_' . $trade_img_height . ',w_' . $trade_img_width . '/auto-orient,1/quality,q_50/watermark,image_d2F0ZXJtYXJrLWxvZ28ucG5nP3gtb3NzLXByb2Nlc3M9aW1hZ2UvcmVzaXplLFBfMzU,g_se,x_0,y_0/format,jpg';
            }else{
                $trade_show_image = IMG_BASE_URL . 'tradeshows/' . volgo_maybe_unserialize($trade_show_single_meta['tradeshow_info']['featured_image']) . '?x-oss-process=image/resize,m_fixed,h_210,w_260/auto-orient,1/quality,q_50/watermark,image_d2F0ZXJtYXJrLWxvZ28ucG5nP3gtb3NzLXByb2Nlc3M9aW1hZ2UvcmVzaXplLFBfMzU,g_se,x_0,y_0/format,jpg';
            }
