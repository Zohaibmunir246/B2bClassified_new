...
class MobilePaymentPlans extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('frontend-mobile/payment_plans/paymentplans', $data);
    }
...
//        $package_id = $_GET['package_id'];
        ...
        if (volgo_front_is_logged_in()) {
            ...
            $this->load->view('frontend-mobile/payment_plans/payment_details_mobile', $data);
